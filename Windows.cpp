...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, LPWSTR, INT)
{
	WNDCLASSEX wc = { sizeof(WNDCLASSEX), CS_CLASSDC, MsgProc, 0, 0,
		...
		"Bean DirectX Framework Window", NULL };
	...
	HWND hWnd = CreateWindowW(L"Bean DirectX Framework Window", L"Bean DirectX Framework",
	...
	UnregisterClass("Bean DirectX Framework Window", wc.hInstance);
	return 0;
}